...
/*!
 * Crate utils_rust. Provides rust version implementation of c_utils. Current it essentially call C++ interfaces via FFI.
 */

/// Module Ashmem. Provides interfaces to operate on ashmem(Anonymous shared memory).
pub mod ashmem;
